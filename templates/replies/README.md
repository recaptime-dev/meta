...
Here is a list of common **reply messages** shared by team members to help them respond to issues.
Some of them are adopted from [OpenCollective's meta issue tracker](https://github.com/opencollective/opencollective/tree/main/.github/MAINTAINER_REPLY_TEMPLATES).
...
- [Use chatroom/public inbox for support](do-not-use-issue-tracker-for-support.md)
